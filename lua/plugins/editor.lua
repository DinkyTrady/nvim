...
return {
  ...
  },
  {
    ...
    keys = {
      { ";w", Util.telescope("live_grep"), desc = "Grep (root dir)" },
      -- find
      ...
      { ";c", Util.telescope.config_files(), desc = "Find Config File" },
      { ";f", Util.telescope("files", { find_command = { "fd" } }), desc = "Find Files (root dir)" },
      { ";F", Util.telescope("files", { find_command = { "fd" }, cwd = false, hidden = true }), desc = "Find Files (cwd)" },
      { ";r", "<cmd>Telescope oldfiles<cr>", desc = "Recent" },
      { ";R", Util.telescope("oldfiles", { cwd = vim.loop.cwd() }), desc = "Recent (cwd)" },
      -- search
      ...
      { ";W", Util.telescope("live_grep", { cwd = false, hidden = true }), desc = "Grep (cwd)" },
