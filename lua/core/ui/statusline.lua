...
local modes = {
  ["n"] = { "Nor", "normalmode" },
  ["niI"] = { "Nor-I", "normalmode" },
  ["niR"] = { "Nor-R", "normalmode" },
  ["niV"] = { "Nor-V", "normalmode" },
  ["no"] = { "Nor-P", "normalmode" },
  ["i"] = { "Ins", "Insert" },
  ["ic"] = { "Ins-C", "Insert" },
  ["ix"] = { "Ins-C", "Insert" },
...
local mode = function()
  ...
  local current_mode = "%#" .. modes[m][2] .. "#" .. "   " .. string.format("%s", modes[m][1]):upper()
...
local filetype = function()
  ...
  api.nvim_set_hl(0, "Empty", { fg = "white", bold = true })
...
M.setup = function()
  vim.opt.statusline = "%{%v:lua.require'core.ui.statusline'.config()%}"
end
